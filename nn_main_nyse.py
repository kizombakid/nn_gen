...
def nn_main_nyse(ensemble,ndef, update_data=False, run_nn=True):

    if ensemble==0 or update_data == True:
        xx = NNDCube_nyse(ndef.set, ndef.dates_train, ndef.lookbackA, 't', 'A', ndef.varsiA, ndef.varso, ndef.exp)
        xx = NNDCube_nyse(ndef.set, ndef.dates_val, ndef.lookbackA, 'v', 'A', ndef.varsiA, ndef.varso, ndef.exp)
        xx = NNDCube_nyse(ndef.set, ndef.dates_ind, ndef.lookbackA, 'i', 'A', ndef.varsiA, ndef.varso, ndef.exp)
        if ndef.n_nets == 2: 
            xx = NNDCube_nyse(ndef.set, ndef.dates_train, ndef.lookbackB, 't', 'B', ndef.varsiB, None, ndef.exp)
            xx = NNDCube_nyse(ndef.set, ndef.dates_val, ndef.lookbackB, 'v', 'B', ndef.varsiB, None, ndef.exp)
            xx = NNDCube_nyse(ndef.set, ndef.dates_ind, ndef.lookbackB, 'i', 'B', ndef.varsiB, None, ndef.exp)
        if ndef.n_nets == 3: 
            xx = NNDCube_nyse(ndef.set, ndef.dates_train, ndef.lookbackC, 't', 'C', ndef.varsiB, None, ndef.exp)
            xx = NNDCube_nyse(ndef.set, ndef.dates_val, ndef.lookbackC, 'v', 'C', ndef.varsiB, None, ndef.exp)
            xx = NNDCube_nyse(ndef.set, ndef.dates_ind, ndef.lookbackC, 'i', 'C', ndef.varsiB, None, ndef.exp)
